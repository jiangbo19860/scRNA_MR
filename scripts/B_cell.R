...
save(scRNA,file = "scRNA_B_cell.Rds")
load("scRNA_B_cell.Rds")
...
ggsave(filename = "Fig/Fig4a.pdf",height = 8,width = 8)
...
ggsave(filename = "Fig/Fig4a1.pdf",height = 8,width = 8)
...
ggsave("Fig/Fig4_endo_bar.pdf",height = 4,width = 10)
...
ggsave("Fig/Fig4b.pdf",height = 6,width = 9)
...
scRNAsub <-subset(scRNA,seurat_clusters %in% c(0,2,6))
...
write.csv(x, "FB_gsva_limma.csv", quote = F)
...
ggsave(filename = "Fig/Fig4c.pdf",height = 12,width = 8)
